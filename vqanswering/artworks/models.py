...
class Artwork(models.Model):
    ...
    user_image = models.ImageField(upload_to='static/assets/img/full', verbose_name='Upload Image', default='default.jpg')
    image = models.CharField(max_length=200, editable=False)
    thumb_image = models.CharField(max_length=200, editable=False)
