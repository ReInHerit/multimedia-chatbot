...
def revision_result(request):
    ...
    context = {
        ...
        "nonaQ": 2 + obj.filter(
            question_error_type="Indefinite article instead of definite article or viceversa").count(),
        ...
        "settimaA": 2 + obj.filter(
            answer_error_type="Indefinite article instead of definite article or viceversa").count(),
