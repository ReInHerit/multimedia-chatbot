...
from bert_evaluation.bert_eval import normalize_answer, compute_exact, compute_f1, make_eval_dict, get_raw_scores,apply_no_ans_threshold, merge_eval, find_best_thresh
...
question_answering_model = QuestionAnsweringModel('distilbert', 'distilbert-base-uncased-distilled-squad', args={'reprocess_input_data': True, 'overwrite_output_dir': True})
